...
SECRET_KEY = "2-c%ccuwm&32*0%h^ja6wu0x9y3%8((kd_02v9fhndf^okn1_*"
...
ROOT_URLCONF = 'usdm.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'usdm.wsgi.application'
...
DEFAULT_FROM_EMAIL = "hello@usdm.com"
SERVER_EMAIL = "error@usdm.com"
from usdm.settings.app import *


SOUTH_TESTS_MIGRATE = False

GRAPPELLI_ADMIN_TITLE = 'usdm'
